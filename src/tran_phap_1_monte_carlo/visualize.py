...
def plot_repeated_runs(df, agg: dict, save_path) -> None:
    ...
    # Trái: đường biểu diễn từng lần chạy
    ...
    fig.suptitle(
        f"Trận Pháp 1 (Repeated Trials): {agg['n_runs']} lần chạy × "
...
def plot_summary(stats_vo_vi: dict, stats_tinh_cam: dict, save_path) -> None:
    ...
    # Biểu đồ 1: % người chơi bị trùng vé với ai đó
    ...
    # Biểu đồ 2: cụm vé trùng đông nhất
